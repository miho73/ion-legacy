                ...
                <Row className='my-3'>
                    ...
                    <Row className='mb-2'>
                        ...
                        <ul>
                            ...
                            <li>ACTIVATED : IonID가 Ion에서 사용될 수 있는 상태입니다. IonID가 생성된 직후 관리자가 IonID를 활성화하면 이 상태로 설정됩니다.</li>
                    ...
                    <Row className='mb-2'>
                        ...
                        <div className='border p-3'>
                            ...
                            <p>이진수의 각 자릿수는 각 권한을 뜻하고 그 자리수가 1인 경우 권한이 있는것, 0인 경우 권한이 없는 것입니다. 이진수로써 더해지는 수는 권한코드와 같습니다.</p>
                ...
                <Row className='mb-3'>
                    ...
                    <Row className='mb-2'>
                        ...
                        <Row>
                            ...
                            <p>한 학년에서 신청된 모든 면불 목록을 리스트로 보여주고 출력할 수 있도록 합니다. 승인된 면불만 볼 수도 있고 아직 승인되지 않았거나 거절된 면불도 볼 수 있습니다. 하지만 면불 목록을 출력할 때는 승인된 면불만 출력할 수 있습니다.</p>
                        </Row>
                        <Row>
                            ...
                            <p>면불을 추가합니다. 면불을 추가하려면 면불자의 IonID, 면불 장소, 면불 사유를 입력해야합니다. 여기서 추가된 면불의 담당교사는 추가한 본인이 됩니다. 면불을 추가한 후 별도로 승인해야 합니다.</p>
                        </Row>
                        <Row>
                    ...
                    <Row className='mb-2'>
                        ...
                        <Row>
                            ...
                            <p>IonID의 기본 상태를 변경합니다. IonID의 기본 상태는 IonID가 생성될 때 자동으로 설정되는 상태입니다. 학년초와 같이 대규모의 IonID 승인이 필요한 상황을 위해 있는 기능입니다.</p>
