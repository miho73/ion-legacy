...
function Deula() {
    return (
        <div className='vstack docs'>
            <p className='fw-bold'>이 약관은 2023년 07월 17일 업데이트되었습니다.</p>
            <p className='fw-bold'>Ion 서비스를 사용하기 전 본 약관을 주의깊게 읽어주세요. IonID를 생성함에 따라 본 약관에 동의하는 것으로 간주됩니다.</p>
            <h3>Ion의 이용</h3>
            <ol>
                <li>Ion 서비스의 이용은 이용하고자 하는 자가 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 Ion이 이를 승낙함으로서 시작됩니다.</li>
                <li>
                    <p>Ion은 가입 신청자의 신청을 승낙함을 원칙으로 합니다. 다만 다음 경우에는 승낙을 하지 않고 유보, 거절할 수 있습니다.</p>
                    <ul>
                ...
                <li>
                    <p>Ion 서비스의 이용 지격은 다음 각 조건을 말합니다.</p>
                    <ul>
            ...
            <ol>
                <li>
                    ...
                    <ul>
                        ...
                        <li>외설 또는 폭력적인 메시지, 화상, 음성, 기타 부적절한 정보를 서비스에 공개 또는 개시하는 행위</li>
            ...
            <ol>
                ...
                <li>
                    <p>서비스의 제공은 업무상, 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간 운영을 원칙으로 합니다. 다만 Ion의 책임이 없는 기술적 문제가 발생하거나 정기점검을 하는 경우는 예외로 합니다.</p>
                </li>
            </ol>
            ...
            <h3>개인정보취급방침</h3>
            <p>Ion은 이용자의 개인정보를 소중하게 여기며 이를 보호하기 위해 최선을 다합니다. 이 단에서는 Ion이 어떠한 개인정보를 어떤 이유로 어떻게 수집하고 어떻게 보관, 관리하는지 설명합니다.</p>
            <ol>
                <li>
                ...
                <li>
                    ...
                    <ul>
                        <li>
                            <p className='fw-bold'>쿠키의 사용 목적</p>
                            <p>이용자의 인증 상태 저장</p>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p>Ion은 개인정보가 저장되고 처리되는 서버에 대한 물리적 접근을 제한하여 개인정보의 유출이 발생하지 않도록 하고 있습니다.</p>
                        </li>
                        <li>
                            <p className='fw-bold'>개인 IonID와 비밀번호 관리</p>
                            <p>Ion에 저장되는 비밀번호는 복원 불가능한 방법으로 암호화됩니다.</p>
