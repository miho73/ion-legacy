...
function Deula() {
    return (
        <div className='vstack docs'>
            ...
            <h3>Ion의 이용</h3>
            <ol>
                <li>Ion 서비스의 이용은 이용하고자 하는 자가 약관의 내용에 대하여 동의를 한 다음 회원가입신청을 하고 Ion이 이를 승낙한 후 최종적으로 IonID가 처음 활성화되며 시작됩니다.</li>
                <li>
            ...
            <ol>
                ...
                <li>서비스의 제공은 업무상, 기술상 특별한 지장이 없는 한 연중무휴 1일 24시간 운영을 원칙으로 합니다. 다만 Ion의 책임이 없는 기술적 문제가 발생하거나 정기점검을 하는 경우는 예외로 합니다.</li>
            </ol>
            <h3>서비스 제공의 변경 및 중지</h3>
            <ol>
                <li>
                    <p>Ion은 긴급한 시스템 점검, 증설, 교체, 설비의 장애, 서비스 이용의 폭주, 정전, 국가비상사태, 천재지변 등 부득이한 사유가 발생한 경우 사전 예고 없이 일시적으로 서비스를 중지할 수 있습니다.</p>
                </li>
                <li>
            ...
            <h3>개인정보취급방침</h3>
            <p>Ion은 이용자의 개인정보를 소중하게 여기며 이를 보호하기 위해 최선을 다합니다. 이 단에서는 Ion이 어떤 개인정보를 어떤 이유로 어떻게 수집하고 어떻게 보관, 관리하는지 설명합니다.</p>
            <ol>
                <li>
                ...
                <li>
                    ...
                    <p>이 사이트는 회원가입일로부터 서비스를 제공하는 기간 동안에 한하여 이용자의 개인정보를 보유 및 이용하게 됩니다. 이용자의 개인정보는 개인정보의 수집 및 이용목적이 달성되면 지체 없이 파기됩니다.</p>
                ...
                <li>
                    ...
                    <ol>
                        <li>
                            ...
                            <p>Ion은 이용자의 인증 상태 저장을 위해 이용자의 정보를 수시로 저장하고 불러오는 쿠키(Cookie)를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버가 이용자의 브라우저에 저장하는 텍스트로서 이용자의 컴퓨터 저장장치에 저장됩니다. Ion은 다음 목적을 위해 쿠키를 사용합니다.</p>
                            <ul>
                                <li>이용자의 인증 상태 저장</li>
                            </ul>
                            <p>이용자는 쿠키 사용에 대한 선택권을 가지고 있습니다. 따라서 웹브라우저를 통해 쿠키를 허용하거나, 쿠키를 저장할 때 확인을 받거나, 쿠키를 사용하지 않을 수 있습니다. 다만 쿠키를 사용하지 않을 때 로그인이 필요한 서비스 이용에 어려움이 있을 수 있습니다.</p>
                        </li>
                        <li>
                            <p className='fw-bold'>서비스 이용 통계 분석</p>
                            <p>Ion은 서비스 이용 통계 분석을 목적으로 구글(Google)에서 제공하는 로그 분석툴인 Google Analytics를 사용하고 있습니다. Google Analytics를 통하여 Ion의 웹사이트 이용자의 행태정보를 수집하게 되며, 이 경우에도 개인을 식별할 수 없는 정보만이 수집됩니다. 이러한 정보처리를 원하지 않는 경우 아래 안내 페이지를 통해 정보 처리를 거부할 수 있습니다.</p>
                            <p>Google Analytics 설정 해제 방법 <Link to='https://tools.google.com/dlpage/gaoptout' className='text-decoration-none' target='_blank'>보기</Link></p>
                        </li>
                    </ol>
                </li>
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p>Ion은 개인정보가 저장되고 처리되는 서버에 대한 물리적 접근을 제한하여 개인정보의 유출이 발생하지 않도록 하고 있습니다. 또한 관리에 필수적인 최소한의 인원만이 개인정보에 접근할 수 있도록 하고 있습니다.</p>
                        </li>
                        <li>
                            <p className='fw-bold'>개인 IonID와 비밀번호 관리</p>
                            <p>이용자의 개인정보는 비밀번호에 의해 보호되며 인가되지 않은 접근이 발생하지 않도록 통제되고 있습니다.</p>
                            <p>이용자가 사용하는 IonID는 이용자 본인만이 사용하도록 되어있습니다. 이용자의 개인적 부주의로 IonID, 비밀번호, 개인정보가 유출되어 발생하는 문제와 기본적인 인터넷의 위험성 때문에 일어나는 일들에 대해 Ion은 책임을 지지 않습니다. 충분히 복잡한 비밀번호를 설정하고 공용PC에서 로그인시 개인정보가 유출되지 않도록 각별한 주의를 기울여 주시기 바랍니다.</p>
                        </li>
                    </ol>
                </li>
            </ol>
