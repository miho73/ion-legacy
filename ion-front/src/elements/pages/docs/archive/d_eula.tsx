...
function Deula() {
    return (
        <div className='vstack docs'>
            <p className='fw-bold'>이 약관은 2023년 09월 18일 업데이트되었습니다.</p>
                ...
                <li>
                    ...
                    <ol>
                        ...
                        <li>
                            ...
                            <p>사용자의 개인정보는 Microsoft가 제공하는 Azure 서버를 통하여 저장, 관리됩니다. 이 약관에 동의함에 따라 Azure를 통한 개인정보의 저장 및 처리에 동의하게 됩니다.</p>
                        </li>
                        <li>
