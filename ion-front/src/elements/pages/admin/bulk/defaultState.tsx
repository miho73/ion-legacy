        ...
        <>
            <Stack>
                ...
                <ButtonGroup className='w-fit mb-2'>
                    <Button disabled={working} onClick={() => exec(0)} variant='warning' className='w-fit'>INACTIVATED</Button>
                    <Button disabled={working} onClick={() => exec(1)} variant='success' className='w-fit'>ACTIVATED</Button>
                    <Button disabled={working} onClick={() => exec(2)} variant='danger' className='w-fit'>BANNED</Button>
                </ButtonGroup>
                {current !== '' &&
                    <p>현재 설정: {current}</p>
                }
